...
4. **Update cache invalidation.** Edit the Published Regular Post directly, save the changes, and reload the public detail and homepage without restarting the app. Both must show the new text immediately. Editing does not change the Post status.

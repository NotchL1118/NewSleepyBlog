...
4. Start Supabase locally, apply migrations, and start the Next.js app.
...
After signing in through GitHub once, copy the user's UUID from Supabase Authentication → Users and run this one-time statement in the SQL editor:
